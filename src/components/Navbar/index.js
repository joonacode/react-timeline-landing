      ...
      <div className='container mx-auto py-7 px-10'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center'>
            <div>
              <img src={Logo} className='h-10 w-10 cursor-pointer' alt='logo' />
            </div>
            <div className='lg:ml-20 md:ml-10  items-center md:flex hidden'>
              <span className='mr-10 text-sm cursor-pointer text-gray-800 hover:opacity-90'>
                HOME
              </span>
              <span className='mr-10 text-sm cursor-pointer text-gray-800 hover:opacity-90 opacity-50'>
                PLANS
              </span>
              <span className='mr-10 text-sm cursor-pointer text-gray-800 hover:opacity-90 opacity-50'>
                FEATURES
